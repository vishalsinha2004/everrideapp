              ...
              <TouchableOpacity key={item.id} style={styles.cardWrapper} activeOpacity={0.8}>
                ...
                >
                  ...
                  <View style={styles.cardBottomText}>
                    <Text style={styles.serviceLabel} numberOfLines={1} adjustsFontSizeToFit>{item.label}</Text>
                    <Text style={[styles.serviceSubtitle, { color: item.iconBg }]} numberOfLines={1} adjustsFontSizeToFit>{item.subtitle}</Text>
                  </View>
                </LinearGradient>
              </TouchableOpacity>
            ))}
