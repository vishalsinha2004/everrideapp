...
const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    icon: (color, size) => (
      <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
        <Path d="M5 8h14" />
        <Path d="M5 8v3c0 1 .895 2 2 2h2c1.105 0 2-1 2-2V8" />
        <Path d="M5 11h4v3c0 1 .895 2 2 2h2c1.105 0 2-1 2-2v-3h4" />
        <Path d="M9 5v3" />
        <Path d="M15 5v3" />
      </Svg>
    ),
  ...
  return (
    <LinearGradient colors={[COLORS.gradientTop, COLORS.gradientBottom]} style={styles.gradientBackground}>
      <SafeAreaView style={styles.safeArea}>
        ...
        {/* Reusing your TopNavbar exactly as is */}
        <TopNavbar />
      ...
      {/* FIXED: BottomBar automatically detects active tab from route */}
      <BottomBar />
    </LinearGradient>
  );
}
...
const styles = StyleSheet.create({
  ...
  avatarInitial: {
    fontSize: 24, // Slimmer font size
    fontFamily: 'Poppins-Regular', // Slimmer font weight
    color: '#FFFFFF',
  ...
  phoneNumber: {
    fontSize: 18,
    fontFamily: 'Poppins-Medium', // Slimmer than bold/black
    color: COLORS.navy,
    marginBottom: 2,
  },
  viewProfile: {
  ...
  // MENU GROUPS
  menuGroup: {
    backgroundColor: COLORS.whiteGlass, // Fixed background color perfectly
    borderRadius: 20,
    overflow: 'hidden',
    borderWidth: 1,
    borderColor: '#FFFFFF',
